...
var logFile = process.env.POPBOX_LOG_FILE || './popbox.log';
...
exports.logger.File = {
  level: 'debug', filename: logFile, timestamp: true, json: false,
 ...
 * @type {Boolean}
 */
exports.showDeployInformation = false;
...
var gevLsnrMongo = process.env.POPBOX_GEN_MONGO || 'localhost',
    gevLsnrMongoPort = process.env.POPBOX_GEN_MONGO || '27017';

var gevLsnr = {};
gevLsnr.name = 'gevlsnr-state';
gevLsnr.event = 'NEWSTATE';
gevLsnr.mongoHost = gevLsnrMongo;
gevLsnr.mongoPort = gevLsnrMongoPort;
...
gevLsnrAction.mongoPort = gevLsnrMongoPort;
