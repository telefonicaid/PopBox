...
var setRoutes = function setRoutes(server) {
  ...
  if (server.isSecure) {
    ...
    server.post('/queue/:id/subscribe', prefix, logic.checkPerm, logic.httpSubscribeQueue);
    ...
    server.post('/org/:id_org/queue/:id/subscribe', prefix, logic.checkPerm, logic.httpSubscribeQueue);

  }
  else {
    server.post('/queue/:id/pop', prefix, logic.popQueue);
    server.get('/queue/:id/peek', prefix, logic.peekQueue);
    server.post('/queue/:id/subscribe', prefix, logic.httpSubscribeQueue);
    ...
    server.post('/org/:id_org/queue/:id/subscribe', prefix, logic.httpSubscribeQueue);
  }
